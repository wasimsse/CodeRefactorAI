...
class ProjectAnalyzer:
    ...
    def analyze_project(self, project_path: str) -> Dict[str, Any]:
        """Analyze an entire project and return metrics."""
    ...
    def get_project_structure(self, project_path: str) -> Dict:
        """Return the project's directory structure."""
        structure = {}
        
        for root, dirs, files in os.walk(project_path):
            current = structure
            path = os.path.relpath(root, project_path)
            ...
            for file in files:
                current[file] = os.path.join(path, file)
        
        return structure

# Create a default project analyzer instance
